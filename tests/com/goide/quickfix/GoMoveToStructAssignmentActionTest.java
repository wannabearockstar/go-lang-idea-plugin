...
import com.goide.codeInsight.intention.GoMoveToStructAssignmentAction;
import org.jetbrains.annotations.NotNull;

public class GoMoveToStructAssignmentActionTest extends GoQuickFixTestBase {
  @Override
  ...
  protected String getBasePath() {
    return "intention/move-to-struct-assignment";
  }

  private void doTest()                              { doTest(GoMoveToStructAssignmentAction.NAME); }
  private void doTestNoFix()                         { doTestNoFix(GoMoveToStructAssignmentAction.NAME); }

  public void testSimple()                           { doTest(); }
  public void testTwoFieldsInAssignment()            { doTest(); }
